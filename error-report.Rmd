---
title: "Elevated Blood Lead Levels in NYC Children from 2005-2016"
author: "Ashley James"
output:
...
## Graph 1: Graphing the average number of children with BLL of 5ug/dl or higher by borough in NYC
...
#make bar chart 
bll5_complete <- readRDS("data/avg-bll5-by-borough-complete")
ggplot(data = bll5_complete, 
...
labs(title = "While the count of children with elevated blood lead levels has<br>decreased in every borough from 2005 to 2016,
     <span style='color:#02401B'>Brooklyn</span> continues<br>to have the highest numbers", y = "Children with Elevated Bllod Lead Levels", x = "Year") +
theme_minimal() +
