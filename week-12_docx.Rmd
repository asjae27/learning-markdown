...
gg_avg_levels_by_borough <- bll5_complete %>% 
...
ggsave("ggplot2-charts/gg_avg_levels_by_borough.png",
       gg_avg_levels_by_borough,
       width = 12,
       height = 8,
       units = "cm")

knitr::include_graphics("ggplot2-charts/gg_avg_levels_by_borough.png")
```
